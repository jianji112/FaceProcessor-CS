...
public static class AudioMerger
{
	...
	public static string FfmpegDirectoryPath => Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "ffmpeg");

	public static string FfmpegExecutablePath => Path.Combine(FfmpegDirectoryPath, "ffmpeg.exe");

	public static string FfprobeExecutablePath => Path.Combine(FfmpegDirectoryPath, "ffprobe.exe");
	...
	public static async Task InitializeAsync()
	{
		...
		try
		{
			string ffmpegPath = FfmpegDirectoryPath;
